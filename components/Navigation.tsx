                ...
                <div className="flex justify-between h-16">
                    ...
                    <div className="flex">
                        <div className="hidden font-ubuntu space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <NavLink href="https://github.com/yoshihiko99/yoshihiko99.github.io" target={"_blank"}>
                                Source
                            </NavLink>
                        </div>
                    </div>
                ...
                <div className="block sm:hidden">
                    <div className="py-1 border-t border-gray-200">
                        <div className="my-3 space-y-1">
                            ...
                            <ResponsiveNavLink href="/works" active={router.pathname === '/works'}>
                                Works
                            </ResponsiveNavLink>
                            <ResponsiveNavLink href="https://github.com/yoshihiko99/yoshihiko99.github.io"
                                               target={"_blank"}>
                                Source
                            </ResponsiveNavLink>
                        </div>
